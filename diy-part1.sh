...
#kenzo 库冲突大佬处理2_https://github.com/kenzok8/small-package  #20241118 miniupnpd报错
rm -rf feeds/smpackage/{base-files,dnsmasq,firewall*,fullconenat,libnftnl,nftables,ppp,opkg,ucl,upx,vsftpd*,miniupnpd-iptables,wireless-regdb，miniupnpd}
